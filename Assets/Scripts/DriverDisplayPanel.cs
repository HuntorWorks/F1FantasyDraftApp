...
public class DriverDisplayPanel : MonoBehaviour
{
    ...
    private IEnumerator SelectDriver()
    {
        ...
        {
            currentSelectedDriverSO = driverSoList[GetRandomDriverSOIndex()];
            yield return StartCoroutine(DriverSpinAnimtion(currentSelectedDriverSO));
    ...
    private void ChangeDisplay(DriverSO driverSo) {
        this.backgroundColor.color = driverSo.backgroundColor;
